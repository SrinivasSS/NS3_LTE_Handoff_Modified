...
for i=1:(k-1)
    ...
    %Normal Handoffs
         if (SINR1(i)>(SINR2(i)+hyst)) && (SINR1(i)>(SINR3(i)+hyst))
        highest_sinrweight(i)=1;
        rate_sinr(i)=w*log2(1+power(10,SINR1(i)/10));
    else if (SINR2(i)>(SINR1(i)+hyst)) && (SINR2(i)>(SINR3(i)+hyst))
        highest_sinrweight(i)=2;
        rate_sinr(i)=w*log2(1+power(10,SINR2(i)/10));
    else highest_sinrweight(i)=3;
        rate_sinr(i)=w*log2(1+power(10,SINR3(i)/10));
        end
    end
